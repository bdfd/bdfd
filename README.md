...
<!-- YOUTUBE:START --><div style="margin:0;padding:0;font-family:sans-serif;@keyframes gradientBackground{0%{background-position-x:0}100%{background-position-x:100%}}"><div style=height:120px;display:flex;align-items:center><a style="display:flex;align-items:center;text-decoration:none;color:inherit;height:118px;border:1px solid rgba(0,0,0,.2);padding:10px 20px;border-radius:10px;background:#fff;background:linear-gradient(60deg,rgba(255,255,255,1) 0,rgba(255,255,255,1) 47%,rgba(246,246,246,1) 50%,rgba(255,255,255,1) 53%,rgba(255,255,255,1) 100%);background-size:600% 400%;animation:gradientBackground 3s ease infinite;overflow:hidden;text-overflow:ellipsis" href=https://www.youtube.com/watch?v=1p95V_NsFD4 target=__blank><img style=margin-right:10px;width:150px;height:100%;object-fit:cover src="https://i.ytimg.com/vi/1p95V_NsFD4/mqdefault.jpg"><div style=flex:1><h3 style=color:#333>2Post Profile</h3><small style=color:#888;display:block;margin-top:5px;margin-bottom:8px>Jan 10, 2022</small></div></a></div></div><div style="margin:0;padding:0;font-family:sans-serif;@keyframes gradientBackground{0%{background-position-x:0}100%{background-position-x:100%}}"><div style=height:120px;display:flex;align-items:center><a style="display:flex;align-items:center;text-decoration:none;color:inherit;height:118px;border:1px solid rgba(0,0,0,.2);padding:10px 20px;border-radius:10px;background:#fff;background:linear-gradient(60deg,rgba(255,255,255,1) 0,rgba(255,255,255,1) 47%,rgba(246,246,246,1) 50%,rgba(255,255,255,1) 53%,rgba(255,255,255,1) 100%);background-size:600% 400%;animation:gradientBackground 3s ease infinite;overflow:hidden;text-overflow:ellipsis" href=https://www.youtube.com/watch?v=_BFxlmZKH98 target=__blank><img style=margin-right:10px;width:150px;height:100%;object-fit:cover src="https://i.ytimg.com/vi/_BFxlmZKH98/mqdefault.jpg"><div style=flex:1><h3 style=color:#333>1Post Profile</h3><small style=color:#888;display:block;margin-top:5px;margin-bottom:8px>Jan 10, 2022</small></div></a></div></div><div style="margin:0;padding:0;font-family:sans-serif;@keyframes gradientBackground{0%{background-position-x:0}100%{background-position-x:100%}}"><div style=height:120px;display:flex;align-items:center><a style="display:flex;align-items:center;text-decoration:none;color:inherit;height:118px;border:1px solid rgba(0,0,0,.2);padding:10px 20px;border-radius:10px;background:#fff;background:linear-gradient(60deg,rgba(255,255,255,1) 0,rgba(255,255,255,1) 47%,rgba(246,246,246,1) 50%,rgba(255,255,255,1) 53%,rgba(255,255,255,1) 100%);background-size:600% 400%;animation:gradientBackground 3s ease infinite;overflow:hidden;text-overflow:ellipsis" href=https://www.youtube.com/watch?v=A8j64YQCTyk target=__blank><img style=margin-right:10px;width:150px;height:100%;object-fit:cover src="https://i.ytimg.com/vi/A8j64YQCTyk/mqdefault.jpg"><div style=flex:1><h3 style=color:#333>Test</h3><small style=color:#888;display:block;margin-top:5px;margin-bottom:8px>Jan 10, 2022</small></div></a></div></div><!-- YOUTUBE:END -->
